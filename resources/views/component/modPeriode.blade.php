...
<div class="card">
    <div class="card-body">
      <h5 class="card-title">Modifier la période</h5>

      <!-- Horizontal Form -->
      <form action="modPeriode" method="POST">
        @csrf
        ...
        <div class="row mb-3">
            <label for="email" class="form-label">année scolaire</label>
        <select name="ida" class="form-select " id="">
          @foreach ($annesco as $item)
